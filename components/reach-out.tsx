      ...
      >
        ...
        <div className="relative z-[30]">
          ...
          <div className="flex flex-col gap-y-2">
            ...
            <a
              className="blur-[3px] focus:blur-0  hover:blur-0 text-[14px] md:text-[18px] lg:text-5 font-switzer text-dark dark:text-light underline underline-purple underline-offset-4 hover:text-dark/90 dark:hover:text-light/90 transition-all delay-0 duration-200"
