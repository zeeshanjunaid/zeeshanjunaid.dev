...
// Keep the old components for backward compatibility but mark them as deprecated
export const QuotedIconLight = QuotedIcon;
export const QuotedIconDark = QuotedIcon;
