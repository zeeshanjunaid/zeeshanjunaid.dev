...
const ServiceCard = ({
  ...
  return (
    ...
    >
      {/* Main Card Container */}
      <div className="relative bg-light dark:bg-dark rounded-3xl overflow-hidden border border-lightBorderColor dark:border-darkBorderColor">
        ...
        <div className="relative z-20 p-8 md:p-10 lg:p-12">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 mb-8">
            ...
            <div className="flex-1 flex flex-col justify-between">
              ...
              {/* Quick Stats */}
              <div className="flex items-center gap-6 mt-6 pt-6 border-t border-lightBorderColor dark:border-darkBorderColor">
                <div className="flex items-center gap-2">
                  <Star className="w-4 h-4 text-purple" />
                  <span className="text-[12px] md:text-[14px] font-switzer font-medium text-dark/70 dark:text-light/70 uppercase tracking-wider">
                    Premium Quality
                  </span>
                </div>
                <div className="flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            >
              ...
              <div className="relative bg-light dark:bg-dark rounded-2xl p-6 border border-lightBorderColor dark:border-darkBorderColor overflow-hidden">
