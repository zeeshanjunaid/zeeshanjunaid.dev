  ...
  return (
    <Container className="mt-8 lg:mt-12 px-5 md:px-7 lg:px-0 relative flex lg:gap-x-5">
      <div className="shrink-0 overflow-hidden rounded-3xl relative hidden lg:block w-[360px] h-[360px]">
        ...
        <Image objectFit="cover" className="aspect-square" src="/images/testimonials/josh-pic.jpg" fill alt="Josh Peters" />
      </div>
      <div className="py-8 px-5 md:p-12 w-full   lg:px-16 rounded-3xl relative flex overflow-hidden">
        <BlurBG className="rounded-3xl" />
        <div className="relative z-20">
          <h2 className="text-[#3F3F3F]/70 dark:text-[#FAFAF6]/70 font-medium font-switzer text-[16px] md:text-[20px] lg:text-[16px] leading-relaxed">
          ...
          <div className="relative mt-8">
            ...
            <p className="italic text-[16px] md:text-[20px] lg:text-[16px] text-dark dark:text-light leading-relaxed md:mr-[72px] lg:mr-0">
