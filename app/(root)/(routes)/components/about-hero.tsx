        ...
        <div className="lg:flex flex-col w-full lg:w-2/3 px-6 md:px-0 lg:pr-8 py-12 md:py-8 justify-start flex-1  relative ">
          ...
          <div className="mt-6 md:mt-8 flex flex-col gap-y-4">
            <p className={paragraphStyles}>
              Hello! I&apos;m a passionate and innovative Frontend Developer
              with a rich background in building sophisticated web applications
              and digital solutions. My journey through the tech industry has
              led me to work with forward-thinking companies like Passage
              Protocol, Ledgy, Mindable Media, and The Bureau Dubai, where
              I&apos;ve left a mark through my commitment to excellence and
            ...
            <p className={paragraphStyles}>
              ...
              the power of seamless collaboration between design and technology
              to create digital experiences that not only meet but exceed user
              expectations.
            </p>
            <p className={paragraphStyles}>
              ...
              application of Agile methodologies to ensure efficient and
              effective project management. My work is characterized by a
              meticulous attention to detail, a relentless pursuit of quality,
              and a constant exploration of new technologies and practices to
