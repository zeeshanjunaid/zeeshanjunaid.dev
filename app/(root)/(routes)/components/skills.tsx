    ...
    <section className="py-16 md:py-20 relative overflow-hidden">
      ...
      <Container className="px-4 md:px-7 lg:px-0">
        ...
        >
          ...
          >
            <div className="relative bg-white dark:bg-gray-900 rounded-3xl p-6 overflow-hidden group">
              ...
              <div className="relative z-20">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <h3 className="font-ao font-bold text-[18px] md:text-[20px] text-gray-900 dark:text-white">
                      Frontend
                    </h3>
                ...
                <p className="text-[14px] font-switzer font-light text-gray-900/80 dark:text-white/80 leading-relaxed">
            ...
            <div className="relative bg-white dark:bg-gray-900 rounded-3xl p-6 overflow-hidden group md:col-span-2 lg:col-span-1">
              <BlurBG className="rounded-3xl" />
              <div className="relative z-20">
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-12 h-12 bg-purple/10 rounded-2xl flex items-center justify-center group-hover:scale-105 transition-transform duration-200">
            ...
            {CoreSkillset.map((skillset, index) => (
              ...
              >
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="font-ao font-bold text-[18px] md:text-[20px] lg:text-[24px] text-gray-900 dark:text-white">
                      {skillset.name}
                    </h3>
                ...
                {/* Skills Grid */}
                <div className="relative bg-white dark:bg-gray-900 rounded-3xl p-8 md:p-10 overflow-hidden">
                  <BlurBG className="rounded-3xl" />
                  <div className="relative z-20">
          ...
          >
            <div className="relative bg-white dark:bg-gray-900 rounded-3xl p-12 overflow-hidden">
              <BlurBG className="rounded-3xl" />
              <div className="absolute inset-0 bg-linear-to-br from-purple/5 via-transparent to-purple/10 rounded-3xl" />
              
              <div className="relative z-20">
                <h3 className="font-ao font-bold text-[24px] md:text-[28px] lg:text-[32px] text-gray-900 dark:text-white mb-4">
                  Let&apos;s Build Something Amazing Together
                </h3>
                <p className="text-gray-900/80 dark:text-white/80 font-switzer font-light text-[16px] md:text-[18px] leading-relaxed max-w-2xl mx-auto mb-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <motion.a
                    ...
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="inline-flex items-center justify-center px-8 py-3 bg-transparent border border-gray-200 dark:border-gray-700 hover:border-purple text-gray-900 dark:text-white hover:text-purple rounded-xl uppercase font-medium font-switzer text-[14px] transition-all duration-300"
                  >
                    View My Work
                  </motion.a>
                </div>
